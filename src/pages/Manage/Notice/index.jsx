...
import NotaiceCss from './index.module.css'
  ...
  render() {
    ...
    const noticeColumns = [
      ...
      },
      {
        ...
        key: 'edit',
        align: 'center',
        render: () => <div className={NotaiceCss.editButtonWrapper}>
          <p id={NotaiceCss.editCharacter}><MyIcon type='icon-chakanxiangqing' />&nbsp;查看详情</p>
        </div>
      }
    ]
    ...
    return (
      <div className={NotaiceCss.mainWrapper}>
        <div className={NotaiceCss.leftWrapper}>
          <NewNotice />
          <p style={{marginBottom: '2%'}}>历史公告</p>
          <div className={NotaiceCss.componentWrapper}>
            <InfoTable columns={noticeColumns} data={noticeData} showTotal={showTotal} pageSize={5} />
          </div>
        </div>
        <div className={NotaiceCss.dashedLine}></div>
        <div className={NotaiceCss.rightWrapper}>
          <NewTask />
